...
It enables static scans for **Infrastructure as Code (IaC)** and **Container Images**, using custom rules. It highlights vulnerable lines in the code, suggests fixes with GitHub Copilot, and presents interactive results.
